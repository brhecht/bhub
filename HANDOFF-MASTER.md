...
**Status:** LIVE. Glossary feature shipped May 1.
...
- **Dynamic Glossary (May 1):** SSG `/glossary` index + `/glossary/[slug]` per-term pages. 42 bootstrap terms live. Weekly Anthropic-backed GitHub Actions cron (Mon 13:00 UTC) with web-search grounding generates new terms. Spec at `tnb-website/BUILD-SPEC.md`. Failure pings brain-inbox.
