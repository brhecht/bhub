...
> **May 14, 2026 — TNB LinkedIn growth model locked.** Strategy session on LinkedIn performance. Locked operating model for current stage: **warm readers → direct ask**. At ~4K follower scale, LinkedIn does not convert cold viewers via CTAs (Brian's correct pushback). The mechanic is substance posts → silent reading → "I read your stuff" moment → direct conversation ("Want me to put you on the Substack? Slack?"). List growth lives off LinkedIn (IRL events, Slack onboarding, podcast cross-promotion, Substack recommendation graph); LinkedIn's job at this scale is impressions + brand recognition + seeding warm readers. 30-day plan (May 14 → June 14): comment program (5 thoughtful/day on 8-10 named accounts), direct-ask reflex installed everywhere, weekly Nico engagement-tracker pull feeding Brian 3-5 personal DMs/week, Tech Week (June 2) content arc + email-capture mechanic, reciprocal cross-posts with podcast guests. Explicitly killed: video clips as primary format (data — they underperform substance posts), LinkedIn Newsletter (same CTA-mechanic problem), generic CTA optimization, "post more." Audience archetype tension still queued for next STRATEGY-CONTEXT session. Updates committed to `tnb-strategy/strategy/OPERATING-STATUS.md`, `STRATEGY-CONTEXT.md`, `HANDOFF.md`. Pending Brian's confirmation: Nico ping with weekly engagement-tracker brief.
>
